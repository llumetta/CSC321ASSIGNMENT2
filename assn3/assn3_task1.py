...
# Alice computes shared secret s using Bob's public key
s_Alice = pow(Y_B, X_A, q)

# Bob computes shared secret s using Alice's public key
s_Bob = pow(Y_A, X_B, q)
...
print("Decrypted message by Alice:", decrypted_message_bob.decode())
